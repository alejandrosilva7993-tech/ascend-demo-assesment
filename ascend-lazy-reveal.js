 ...
 * Espera `ascend:assessment-ready` si el body tiene assessment-preloading.
...
(function () {
  ...
  if (document.body.classList.contains('assessment-preloading')) {
    document.addEventListener('ascend:assessment-ready', startReveal, { once: true });
  } else {
    startReveal();
  }
})();
